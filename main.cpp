...
void renderBunny() {
    MeshTriangle bunny = MeshTriangle::loadObjectFromObjFile("../models/bunny/bunny.obj", redMaterial);
    MeshTriangle bunnyLight = MeshTriangle::loadObjectFromObjFile("../models/bunny/bunny_light.obj", lightMaterial);
